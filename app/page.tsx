...
function Bored(){return <div className="screen-content"><Header kicker="BORED?" title="Pick Your Mischief" text="A mobile home for the fun side of Siouxville."/><div className="tile-grid"><Fun icon={<Sparkles/>} title="Surprise Me" text="Random Grinch joke or challenge"/><Fun icon={<Camera/>} title="TikTok Pics" text="Photo fun and poses"/><Fun icon={<PartyPopper/>} title="Color a Grinch" text="Coloring activities"/><Fun icon={<Users/>} title="Our Friends" text="Community partners"/><Fun icon={<Images/>} title="Photo Gallery" text="Grinch sightings"/><Fun icon={<Gift/>} title="Advent Calendar" text="Daily holiday mischief"/></div></div>}
